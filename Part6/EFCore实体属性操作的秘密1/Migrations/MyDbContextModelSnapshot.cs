...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore实体属性操作的秘密1.ValueObject1", b =>
                {
                    ...
                    b.ToTable("ValueObject1s", (string)null);
                });

            modelBuilder.Entity("EFCore实体属性操作的秘密1.Blog", b =>
                {
                    b.OwnsOne("EFCore实体属性操作的秘密1.Blog.Body#EFCore实体属性操作的秘密1.MultiLangString", "Body", b1 =>
                        {
                            ...
                            b1.ToTable("Blogs", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("BlogId");
                        });

                    b.OwnsOne("EFCore实体属性操作的秘密1.Blog.Title#EFCore实体属性操作的秘密1.MultiLangString", "Title", b1 =>
                        {
                            b1.Property<long>("BlogId")
                                .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EFCore实体属性操作的秘密1.Shop", b =>
                {
                    b.OwnsOne("EFCore实体属性操作的秘密1.Shop.Location#EFCore实体属性操作的秘密1.Geo", "Location", b1 =>
                        {
